...
export default function HealthBar({ health, maxHealth, team }: HealthBarProps) {
  ...
  return (
    <div className="relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-3 border-2 border-amber-600/30 shadow-lg">
      ...
      <div className="relative w-full h-6 bg-gradient-to-br from-slate-900 to-black rounded-lg overflow-hidden border-2 border-amber-800/40 shadow-inner">
        {/* Background pattern */}
