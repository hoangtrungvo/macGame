      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative my-8">
          ...
          <div className="relative bg-gradient-to-br from-amber-900 via-yellow-800 to-amber-950 rounded-2xl p-1 shadow-2xl">
            <div className="bg-gradient-to-br from-slate-800 via-slate-900 to-black rounded-xl px-6 py-4 border-2 border-amber-200/20">
              <div className="flex items-center justify-center gap-6">
                {/* Turn number */}
                <div className="bg-gradient-to-br from-slate-700 to-slate-800 px-4 py-2 rounded-lg border-2 border-slate-600 shadow-md">
                ...
                <div className={`px-5 py-2.5 rounded-xl font-black text-base shadow-xl border-2 ${
                  gameState.currentTurn === 'red' 
                    ? 'bg-gradient-to-br from-red-600 to-red-800 text-white border-red-400/40 shadow-red-500/40' 
                    : 'bg-gradient-to-br from-blue-600 to-blue-800 text-white border-blue-400/40 shadow-blue-500/40'
                }`}
                ...
                {isMyTurn && gameState.status === 'active' && (
                  <div className="bg-gradient-to-br from-yellow-500 to-amber-600 px-4 py-2 rounded-xl border-2 border-yellow-300/50 shadow-lg shadow-yellow-500/50 animate-pulse">
        ...
        {gameState.history.length > 0 && (
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-br from-amber-900/20 via-yellow-800/10 to-amber-950/20 rounded-2xl blur-lg" />
            
            <div className="relative bg-gradient-to-br from-amber-900 via-yellow-800 to-amber-950 rounded-2xl p-1 shadow-xl">
