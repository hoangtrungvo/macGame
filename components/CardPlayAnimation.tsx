    ...
    <div className="fixed inset-0 z-50 pointer-events-none flex items-center justify-center">
      ...
      >
        ...
        <div className="relative w-[180px] h-[260px] rounded-2xl overflow-hidden shadow-2xl">
          ...
          {/* Cost Crystal */}
          <div className="absolute -top-2 -left-2 w-16 h-16 bg-gradient-to-br from-blue-400 to-blue-700 
          ...
          <div className="relative h-full flex flex-col items-center justify-between p-4 pt-10 pb-6">
            ...
            <div className="relative w-28 h-28 flex items-center justify-center">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-200/20 to-amber-900/40 rounded-full blur-md" />
          ...
          {/* Rarity Gem */}
          <div className="absolute bottom-3 left-1/2 -translate-x-1/2 w-8 h-8 bg-gradient-to-br from-amber-300 to-amber-600 
