  ...
  return (
    <div className="fixed inset-0 bg-black/90 backdrop-blur-md flex items-center justify-center z-50 p-4"
      ...
      <div className="relative max-w-xl w-full">
        {/* Outer glow */}
        <div className="absolute inset-0 bg-gradient-to-br from-amber-500/30 via-yellow-600/20 to-orange-700/30 rounded-2xl blur-2xl" />
        
        {/* Main card */}
        <div className="relative bg-gradient-to-br from-amber-900 via-yellow-800 to-amber-950 rounded-2xl p-1 shadow-2xl">
          {/* Inner border */}
          <div className="bg-gradient-to-br from-slate-800 via-slate-900 to-black rounded-xl p-6 border-2 border-amber-200/20">
            {/* Decorative corners */}
            ...
            <div className="text-center mb-6 relative z-10">
              <div className="inline-flex items-center gap-3 bg-gradient-to-r from-transparent via-amber-900/40 to-transparent px-8 py-3 mb-3">
            ...
            {/* Question Box */}
            <div className="relative bg-gradient-to-br from-slate-700 to-slate-900 rounded-xl p-5 mb-5 border-2 border-amber-600/30 shadow-lg">
                  ...
                  <button
                    ...
                    className={`relative w-full p-4 rounded-xl font-bold text-base transition-all group overflow-hidden ${
                      selectedAnswer === option
                        ? 'bg-gradient-to-r from-amber-500 to-yellow-600 text-black border-2 border-amber-300 shadow-xl shadow-amber-500/50 scale-105'
                        : 'bg-gradient-to-br from-slate-700 to-slate-800 text-white hover:from-slate-600 hover:to-slate-700 border-2 border-slate-600 hover:border-amber-600/50 hover:scale-102'
                    }`}
            ...
            <div className="flex gap-4 relative z-10">
              ...
              <button
                onClick={onCancel}
                className="relative flex-1 bg-gradient-to-br from-red-600 via-red-700 to-red-800 hover:from-red-500 hover:via-red-600 hover:to-red-700 text-white font-black py-4 rounded-xl transition-all shadow-xl hover:shadow-2xl hover:scale-105 active:scale-95 border-2 border-red-400/30 overflow-hidden group"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                <span className="relative z-10 text-lg" style={{ textShadow: '1px 1px 3px rgba(0,0,0,0.5)' }}>
                  ❌ Hủy
