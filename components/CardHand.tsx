...
export default function CardHand({ cards, onCardClick, disabled, faceDown = false }: CardHandProps) {
  ...
  const getCardBorderGlow = (type: string) => {
    switch(type) {
      case 'defense': return 'shadow-blue-400/50';
      case 'heal': return 'shadow-green-400/50';
      case 'attack': return 'shadow-orange-400/50';
      case 'thunder': return 'shadow-purple-400/50';
      case 'detox': return 'shadow-cyan-400/50';
    ...
    <div className="flex gap-3 flex-wrap justify-center">
      {cards.map((card, index) => (
        <button
          ...
          disabled={disabled}
          className={`relative w-[140px] h-[200px] rounded-xl overflow-hidden
        ...
        >
            ...
            <>
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="relative">
                  ...
                  {/* Main symbol */}
                  <div className="relative w-20 h-20 rounded-full bg-gradient-to-br from-amber-400 to-amber-700 border-4 border-amber-200/50 shadow-2xl flex items-center justify-center">
          ...
          <div className={`absolute inset-0 bg-gradient-to-br ${getCardGradient(card.type)}`} />
          ...
          <div className="absolute -top-1 -left-1 w-12 h-12 bg-gradient-to-br from-blue-400 to-blue-700 
          ...
          <div className="relative h-full flex flex-col items-center justify-between p-3 pt-8 pb-4">
            ...
            <div className="relative w-20 h-20 flex items-center justify-center">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-200/20 to-amber-900/40 rounded-full blur-sm" />
          ...
          <div className="absolute bottom-2 left-1/2 -translate-x-1/2 w-6 h-6 bg-gradient-to-br from-amber-300 to-amber-600 
